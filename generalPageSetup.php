...
<?php
	...
	function rating($review = false){
    $ratingClass = "rating";
    if($review == true){
    //   $ratingClass = $ratingClass . "-review";
      $checked = "checked";
    }
?>
		<fieldset class="<?php echo $ratingClass;?>">
	    <input type="radio" id="star5" name="<?php echo $ratingClass;?>" value="5" <?php echo $checked;?>/><label class = "full fa fa-star-o" for="star5" title="Awesome - 5 stars"></label>
	    <input type="radio" id="star4half" name="<?php echo $ratingClass;?>" value="4.5" /><label class="half fa fa-star-o" for="star4half" title="Pretty good - 4.5 stars"></label>
	    <input type="radio" id="star4" name="<?php echo $ratingClass;?>" value="4" /><label class = "full fa fa-star-o" for="star4" title="Pretty good - 4 stars"></label>
	    <input type="radio" id="star3half" name="<?php echo $ratingClass;?>" value="3.5" /><label class="half fa fa-star-o" for="star3half" title="Meh - 3.5 stars"></label>
	    <input type="radio" id="star3" name="<?php echo $ratingClass;?>" value="3" /><label class = "full fa fa-star-o" for="star3" title="Meh - 3 stars"></label>
	    <input type="radio" id="star2half" name="<?php echo $ratingClass;?>" value="2.5" /><label class="half fa fa-star-o" for="star2half" title="Kinda bad - 2.5 stars"></label>
	    <input type="radio" id="star2" name="<?php echo $ratingClass;?>" value="2" /><label class = "full fa fa-star-o" for="star2" title="Kinda bad - 2 stars"></label>
	    <input type="radio" id="star1half" name="<?php echo $ratingClass;?>" value="1.5" /><label class="half fa fa-star-o" for="star1half" title="Meh - 1.5 stars"></label>
	    <input type="radio" id="star1" name="<?php echo $ratingClass;?>" value="1" /><label class = "full fa fa-star-o" for="star1" title="Sucks big time - 1 star"></label>
	    <input type="radio" id="starhalf" name="<?php echo $ratingClass;?>" value="0.5" /><label class="half fa fa-star-o" for="starhalf" title="Sucks big time - 0.5 stars"></label>
		</fieldset>
<?php
	}
  function searchForm(){
